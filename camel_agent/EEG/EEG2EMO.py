...
from ..toolkits.musicgen_tool import MusicGenToolkit, MusicGenToolArguments
...
class Subcribe():
    def __init__(self, app_client_id, app_client_secret, **kwargs):
        ...
        # 初始化音乐生成工具
        self.music_toolkit = MusicGenToolkit()
        self.music_gen = self.music_toolkit.get_tools()[0]
    ...
    def on_new_met_data(self, *args, **kwargs):
        try:
            ...
            music_prompt = self.music_gen(music_args)
            print(f"生成音乐提示词: {music_prompt}")
